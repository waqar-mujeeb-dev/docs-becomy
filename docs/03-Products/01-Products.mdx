...
description: Gain valuable insights on deleting, adding, updating, and duplicating products effortlessly
Tags:
  - Add or Update Products
  - Becomy
slug: products/add-update-products
last_update:
  date: 02/22/2024
...
<head>
<meta property="twitter:description" content="Gain valuable insights on deleting, adding, updating, and duplicating products effortlessly"/>
...
- Set a new title.
- Choose whether the product should be active or in unlisted status.
...
6. Optional: Set the product status to active to publish the product on all sales channels, or keep it as unlisted.
...
### Archiving a Product on Becomy

If you want to temporarily remove a product from your online store without deleting it permanently, you can unpublish it. If you unpublish the product, then product is 
moved to offline tab on products list page

To unpublish a product:

Desktop
1. Navigate to Products in your Becomy admin panel.
2. Select the specific product you intend to unpublish.
3. Within the product edit view, locate and toggle on the "Published" option.


### Deleting a Product on Becomy

You can easily delete your products. However, It's important to note that, 
unlike archiving, deleting a product on Becomy results in its irrevocable removal from your store. There's no recourse to recover deleted products, emphasizing the 
gravity of this action. If you find yourself in a situation where a product is out of stock or you no longer wish to showcase it, but hesitate to commit to permanent 
deletion, consider archiving the product instead.

To carry out the irreversible deletion of a product on Becomy:

Desktop
1. Navigate to the Products section within your Becomy admin.
2. Select the specific product slated for deletion.
3. Within the product details page, locate and execute the "Delete product" option.
4. Confirm the permanent deletion by clicking "Delete product."

Exercise caution and judiciously consider the implications before utilizing the delete function. Once a product is deleted, it cannot be restored, making this a critical decision in your store management strategy.