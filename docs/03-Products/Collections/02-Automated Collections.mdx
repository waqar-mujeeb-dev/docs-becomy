...
<Table
  ...
  rows={[
    [
      "contains",
      "Product title, category, variant title, product meta title, meta keywords, and product vendor contains the value you enter. For now, you can enter at least one character and the values you enter can't have start or end spaces.",
    ],
