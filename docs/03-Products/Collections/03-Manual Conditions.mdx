...
description: Create Manual Collections by choosing product you want to feature.
---
...
<MetaData
  ...
  twitterDescription="Create Manual Collections by choosing product you want to feature"
