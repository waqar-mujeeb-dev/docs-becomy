...
<Table
  headers={["Payment Method", "How You Get Paid"]}
  rows={[
    ["Credit Card", "Via your merchant account"],
    ["Apple Pay", "Through Becomy Payments"],
    ["PayPal Express Checkout", "Directly from PayPal"],
  ]}
/>
